                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text("\$",style: TextStyle(fontSize: 10,color: colors.primarycolor),),
                                  Text("100.00",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: colors.primarycolor),),
                                ],
                              ),
                          ...
                          Row(
                            ...
                            Text("By Puma",style: TextStyle(
                              fontSize: 13,color: colors.greycolor
                            ),),
                              Row(
                                children: [
                                  ...
                                  Text("4.3",style: TextStyle(
                                    color: colors.greycolor,fontSize: 11
                                  ),)
                                ],
                              )
                          ],
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    border: Border.all(width: 1,color: colors.greycolor)
                                                  ),
